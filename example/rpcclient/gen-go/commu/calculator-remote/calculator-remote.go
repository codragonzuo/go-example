...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  i32 doconfig(i32 commandid, i32 operationid, string jsonconfig)")
...
func main() {
  ...
  case "doconfig":
    if flag.NArg() - 1 != 3 {
      fmt.Fprintln(os.Stderr, "Doconfig requires 3 args")
      flag.Usage()
    }
    ...
    value2 := argvalue2
    fmt.Print(client.Doconfig(context.Background(), value0, value1, value2))
    fmt.Print("\n")
    break
  case "zip":
    if flag.NArg() - 1 != 0 {
