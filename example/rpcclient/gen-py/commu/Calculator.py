...
import sys
import sharedlib.SharedService
import logging
from .ttypes import *
...
class Iface(sharedlib.SharedService.Iface):
    """
    ...
    def doconfig(self, commandid, operationid, jsonconfig):
        """
        Parameters:
         - commandid
         - operationid
...
class Client(sharedlib.SharedService.Client, Iface):
    """
    Ahh, now onto the cool part, defining a service. Services just need a name
    and can optionally inherit from another service using the extends keyword.
    ...
    def __init__(self, iprot, oprot=None):
        sharedlib.SharedService.Client.__init__(self, iprot, oprot)
    ...
    def doconfig(self, commandid, operationid, jsonconfig):
        ...
        """
        self.send_doconfig(commandid, operationid, jsonconfig)
        return self.recv_doconfig()

    def send_doconfig(self, commandid, operationid, jsonconfig):
        self._oprot.writeMessageBegin('doconfig', TMessageType.CALL, self._seqid)
        args = doconfig_args()
    ...
    def recv_doconfig(self):
        ...
        if mtype == TMessageType.EXCEPTION:
            ...
            iprot.readMessageEnd()
            raise x
        result = doconfig_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "doconfig failed: unknown result")
...
class Processor(sharedlib.SharedService.Processor, Iface, TProcessor):
    def __init__(self, handler):
        sharedlib.SharedService.Processor.__init__(self, handler)
        self._processMap["ping"] = Processor.process_ping
        self._processMap["add"] = Processor.process_add
        self._processMap["calculate"] = Processor.process_calculate
        self._processMap["doconfig"] = Processor.process_doconfig
    ...
    def process_doconfig(self, seqid, iprot, oprot):
        args = doconfig_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = doconfig_result()
        try:
            result.success = self._handler.doconfig(args.commandid, args.operationid, args.jsonconfig)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("doconfig", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class doconfig_args(object):
    ...
    def __init__(self, commandid=None, operationid=None, jsonconfig=None,):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.jsonconfig = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('doconfig_args')
        if self.commandid is not None:
            oprot.writeFieldBegin('commandid', TType.I32, 1)
            oprot.writeI32(self.commandid)
            oprot.writeFieldEnd()
        if self.operationid is not None:
            oprot.writeFieldBegin('operationid', TType.I32, 2)
            oprot.writeI32(self.operationid)
            oprot.writeFieldEnd()
        if self.jsonconfig is not None:
            oprot.writeFieldBegin('jsonconfig', TType.STRING, 3)
            oprot.writeString(self.jsonconfig.encode('utf-8') if sys.version_info[0] == 2 else self.jsonconfig)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(doconfig_args)
doconfig_args.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'commandid', None, None, ),  # 1
    (2, TType.I32, 'operationid', None, None, ),  # 2
    (3, TType.STRING, 'jsonconfig', 'UTF8', None, ),  # 3
)


class doconfig_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('doconfig_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.I32, 0)
            oprot.writeI32(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(doconfig_result)
doconfig_result.thrift_spec = (
    (0, TType.I32, 'success', None, None, ),  # 0
)
